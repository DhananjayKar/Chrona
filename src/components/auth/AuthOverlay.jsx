export default function AuthOverlay({ isRegister, setIsRegister }) {
  return (
    <div
      className={`hidden md:flex absolute top-0 h-full w-1/2 bg-blue-600 text-white flex-col items-center justify-center text-center px-8 transition-all duration-500 ${
        isRegister ? "left-0" : "left-1/2"
      }`}
      style={{
        borderRadius: isRegister ? "0 150px 100px 0" : "150px 0 0 100px",
      }}
    >
      {isRegister ? (
        <>
